...
os.environ["GEMINI_API_KEY_1"] = ""  # Replace with the first Gemini API key
genai.configure(api_key=os.environ["GEMINI_API_KEY_1"])

# Configure the second Gemini API key for medication identification
os.environ["GEMINI_API_KEY_2"] = ""  # Replace with the second Gemini API key
...
def get_drug_interactions(medications):
    ...
    input_message = f"You are a information hub, and you have a vast knowledge of medical data. You can use the medical data you have at your disposal. Please tell me if {medications} can cause any complications using it with food, alcohol, or other medicines."
