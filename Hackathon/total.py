...
def main():
    ...
    while True:
        # Ask if the user wants to add medications via text or image, or if they are done
        input_type = input("Would you like to add medications via 'text' or 'image'? Type 'done' when finished: ").strip().lower()
        ...
        if input_type == "text":
            ...
            print("Invalid input type. Please enter 'text', 'image', or 'done'.")
